...
class Model {
    ...
    {
        Connection con = createConnection();
        PreparedStatement stmt = con.prepareStatement("SELECT from_email,subject,content FROM emails WHERE to_email=? AND flag=? ");
    ...
    {
        Connection con = createConnection();
        PreparedStatement stmt = con.prepareStatement("SELECT to_email,subject,content FROM emails WHERE from_email=? AND flag=? ");
