...
class Controller {
	...
	public void openMenuSelection(int menu, String username) throws Exception
	{
		switch(menu)
		{
			...
			case 2: 
				...
				view.mainMenu();
				break;
			case 3: List<List<String>> draft_mails = model.mDraft(username);
	...
	public void selectOption(String username, String[] to, String sub, String content, int option) throws Exception
	{
		switch(option)
		{
			case 1: model.mNew(username, to, sub, content, option-1);
					view.sentMessage();
					view.mainMenu();
				break;
			case 2: model.mNew(username, to, sub, content, option-1);
					view.saveDraft();
					view.mainMenu();
				break;
			default:view.defaultFunction();
